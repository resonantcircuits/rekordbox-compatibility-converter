...
PROFILES = {
    CompatibilityProfileType.STANDARD: HardwareProfile(
        ...
        description="Standard club setup. Converts FLAC/ALAC to AIFF and normalizes unsupported PCM rates to 44.1/48 kHz.",
    ...
    CompatibilityProfileType.MODERN: HardwareProfile(
        ...
        allowed_sample_rates={
            ...
            "aif": {44100, 48000, 88200, 96000},
            "wav": {44100, 48000, 88200, 96000},
            "flac": {44100, 48000, 88200, 96000},
            "alac": {44100, 48000, 88200, 96000},
            "mp3": {16000, 22050, 24000, 32000, 44100, 48000},
            "aac": {16000, 22050, 24000, 32000, 44100, 48000},
            "m4a": {16000, 22050, 24000, 32000, 44100, 48000, 88200, 96000},
        },
        default_target_format=TargetFormat.AIFF,
    ),
}
