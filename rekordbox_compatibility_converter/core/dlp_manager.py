...
ONELIBRARY_BRIDGE_PROMPT = (
    ...
    "convert the incompatible audio, update Device Library, create backups, and keep every "
    "original audio file.\n\n"
...
ONELIBRARY_BRIDGE_CONFIRM_MESSAGE = (
    ...
    "It will keep every original audio file and create Device Library and waveform backups.\n\n"
